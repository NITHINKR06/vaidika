    ...
    <div className="min-h-screen bg-[#060d1a] text-white flex flex-col p-10 relative overflow-hidden">
      ...
      <div className="text-center mb-8 relative z-10">
        ...
        <div className="text-white/30 text-sm mt-2">
          {mounted && time && time.toLocaleDateString('en-IN', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}
        </div>
      </div>
      ...
      <div className="text-center mt-8 relative z-10">
        <div className="text-2xl font-mono text-white/30 tracking-widest">{mounted && time && time.toLocaleTimeString('en-IN')}</div>
      </div>
    </div>
  )
}
